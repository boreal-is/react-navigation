...
class DrawerView extends React.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "changeSubscription", undefined);
  ...
  componentDidMount() {
    ...
    this.changeSubscription = _reactNative.Dimensions.addEventListener('change', this.updateWidth);
  }
  ...
  componentWillUnmount() {
    var _this$changeSubscript;

    (_this$changeSubscript = this.changeSubscription) === null || _this$changeSubscript === void 0 ? void 0 : _this$changeSubscript.remove();
  }
